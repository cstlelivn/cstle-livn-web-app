...
BEGIN
  ...
  -- Project
  -- start_date/phase mirror what CreateProjectDialog.tsx actually submits:
  -- start_date is a hard-required field there (blocks submission without
  -- one), and `phase` is always set to the first phase's name, not left
  -- blank. end_date uses the same "no explicit phase durations -> start +
  -- 30 days" fallback the dialog uses when phase-by-phase durations
  -- aren't specified. supervisor_id is deliberately left NULL rather than
  -- defaulted to whoever runs this migration (the real dialog defaults it
  -- to the current signed-in user, which isn't meaningful here) -- assign
  -- a real Supervisor from the Project Details screen.
  INSERT INTO public.projects (title, client, location, budget, spent, progress, status, phase, start_date, end_date, description, color, created_at, updated_at)
  VALUES (
    ...
    0,
    'Planning',
    'Inspection and Temporary Protection',
    CURRENT_DATE,
  ...
  INSERT INTO public.tasks (project_id, phase_id, phase, title, description, verification_criteria, status, priority, task_type, crew_required, sequence, created_at, updated_at)
  VALUES (v_project_id, v_phase, 'Inspection and Temporary Protection',
    ...
    'To Do', 'Medium', 'Inspection', 1, 0, now(), now())
  ...
  VALUES (v_project_id, v_phase, 'Inspection and Temporary Protection',
    ...
    'To Do', 'Medium', 'Site Work', 1, 1, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Pre-Repair Coordination',
    ...
    'To Do', 'Medium', 'Planning', 1, 0, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Pre-Repair Coordination',
    ...
    'To Do', 'Medium', 'Planning', 1, 1, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Pre-Repair Coordination',
    ...
    'To Do', 'Medium', 'Inspection', 1, 2, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Site and Unit Protection',
    ...
    'To Do', 'Medium', 'Site Work', 1, 0, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Drywall Opening Repairs',
    ...
    'To Do', 'Medium', 'Trade Work', 1, 0, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Drywall Opening Repairs',
    ...
    'To Do', 'Medium', 'Trade Work', 1, 1, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Drywall Opening Repairs',
    ...
    'To Do', 'Medium', 'Trade Work', 1, 2, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Drywall Opening Repairs',
    ...
    'To Do', 'Medium', 'Trade Work', 1, 3, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Cleanup and Quality Control',
    ...
    'To Do', 'Medium', 'Quality Control', 1, 1, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Project Closeout',
    ...
    'To Do', 'Medium', 'Handover', 1, 0, now(), now());
  ...
  VALUES (v_project_id, v_phase, 'Project Closeout',
    ...
    'To Do', 'Medium', 'Administrative', 1, 1, now(), now());
