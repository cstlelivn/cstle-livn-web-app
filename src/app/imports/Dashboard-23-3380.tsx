import svgPaths from "./svg-00w5el43ac";
...
function SidebarHeader1() {
  return (
    <div className="h-[140.5px] relative shrink-0 w-full" data-name="SidebarHeader">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-neutral-700 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[140.5px] items-center justify-between pb-[25px] pt-[24px] px-[16px] relative w-full">
          <div className="h-[20.829px] relative shrink-0 w-[32px]" data-name="Union">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 21">
              <g id="Union">
                <path d={svgPaths.pa34ae40} fill="var(--fill-0, white)" />
                <path d={svgPaths.p4786000} fill="var(--fill-0, white)" />
              </g>
            </svg>
          </div>
        </div>
...
function App11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[76px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[76px]" />
    </div>
  );
}
...
function App12() {
  return (
    <div className="h-[20px] relative shrink-0 w-[67.211px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[67.211px]" />
    </div>
  );
}
...
function App13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[58.813px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[58.813px]" />
    </div>
  );
}

function SidebarMenuButton13() {
  return (
    <div className="box-border content-stretch flex gap-[8px] h-[32px] items-center overflow-clip pl-[8px] pr-0 py-0 relative rounded-[6px] shrink-0 w-[255px]" data-name="SidebarMenuButton">
      <Icon13 />
      <App13 />
...
function App14() {
  return (
    <div className="h-[20px] relative shrink-0 w-[33.609px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[33.609px]" />
    </div>
  );
}

function SidebarMenuButton14() {
  return (
    <div className="box-border content-stretch flex gap-[8px] h-[32px] items-center overflow-clip pl-[8px] pr-0 py-0 relative rounded-[6px] shrink-0 w-[255px]" data-name="SidebarMenuButton">
      <Icon14 />
      <App14 />
...
function App15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[25.211px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[25.211px]" />
    </div>
  );
}

function SidebarMenuButton15() {
  return (
    <div className="box-border content-stretch flex gap-[8px] h-[32px] items-center overflow-clip pl-[8px] pr-0 py-0 relative rounded-[6px] shrink-0 w-[255px]" data-name="SidebarMenuButton">
      <Icon15 />
      <App15 />
...
function App16() {
  return (
    <div className="h-[20px] relative shrink-0 w-[75.617px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[75.617px]" />
    </div>
  );
}

function SidebarMenuButton16() {
  return (
    <div className="box-border content-stretch flex gap-[8px] h-[32px] items-center overflow-clip pl-[8px] pr-0 py-0 relative rounded-[6px] shrink-0 w-[255px]" data-name="SidebarMenuButton">
      <Icon16 />
      <App16 />
...
function App19() {
  return (
    <div className="h-[20px] relative shrink-0 w-[117.625px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] w-[117.625px]" />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="bg-black h-[782px] relative shrink-0 w-[48px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[782px] items-start relative w-[48px]">
        <SidebarHeader1 />
        <SidebarContent1 />
      </div>
    </div>
...
function SidebarClose() {
  return (
    <div className="box-border content-stretch flex h-[782px] items-start pl-0 pr-px py-0 relative shrink-0" data-name="Sidebar close">
      <div aria-hidden="true" className="absolute border-[#999999] border-[0px_1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <Container1 />
    </div>
  );
}
